...
@include('includes.notification')
    ...
    <div class="table-container">
        ...
        <form action="{{ route('admin.sales.filter') }}" method="POST" class="filter-form">
            @csrf
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header border-0">
                        <h1 class="modal-title">Add Sale</h1>
            ...
            $('#table').DataTable({
                ...
                "drawCallback": function() {
                    $('.table-container .delete').on('click', function() {
                        let id = $(this).attr('id');
                        let url = "{{ route('admin.sales.delete', [':id']) }}";
                    ...
                    $('.table-container .edit').on('click', function() {
                        ...
                        let edit_url = '{{ route("admin.sales.edit", ":value") }}';
                        let update_url = '{{ route("admin.sales.update", ":value") }}';
